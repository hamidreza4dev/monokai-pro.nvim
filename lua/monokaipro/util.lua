...
function util.autocmds(config)
  ...
  if config.flatFloat == true then
    ...
    vim.cmd([[  autocmd FileType qf setlocal winhighlight=Normal:NormalLB,SignColumn:SignColumnLB,CursorLine:CursorLineLB]])
  end

  for _, sidebar in ipairs(config.sidebars) do
    vim.cmd([[  autocmd FileType ]] .. sidebar .. [[ setlocal winhighlight=Normal:NormalDB,SignColumn:SignColumnDB]])
  end
